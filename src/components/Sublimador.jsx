    ...
    React.createElement('div', { className: 'sublimador-main' },
      ...
      React.createElement('div', { className: 'sublimador-panel' },
        React.createElement('div', { className: 'panel-section' },
          ...
          React.createElement('p', { className: 'taza-measure-hint' }, 'Medida recomendada: imagen apaisada (≈ 4 veces más ancha que alta), por ej. 1600×400 px. Así se ve nítida y bien proporcionada en la taza.'),
